                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-4 mt-xl-0 mt-3">
                                                ...
                                                <div class="button-list">
                                                    ...
                                                    <button type="button" class="btn btn-primary btn-sm waves-effect waves-light">Btn Small</button>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6">
                                                ...
                                                <div class="button-list">
                                                    ...
                                                    <button type="button" class="btn btn-primary waves-effect waves-light"><i class="mdi mdi-cog"></i></button>
                                                </div>
                                                <br/>
                                                <div class="button-list">
                                            ...
                                            <div class="col-xl-6 mt-xl-0 mt-3">
                                                ...
                                                <div class="btn-group mb-2">
                                                    ...
                                                    <button type="button" class="btn btn-secondary">3</button>
                                                    <div class="btn-group">
                                                        <button type="button" class="btn btn-secondary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"> Dropdown <i class="mdi mdi-chevron-down"></i> </button>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="btn-group-vertical mb-2">
                                                            ...
                                                            <button type="button" class="btn btn-secondary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"> Button 3 <i class="mdi mdi-chevron-down"></i> </button>
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item" href="#">Dropdown link</a>
                                                                <a class="dropdown-item" href="#">Dropdown link</a>
                                                            </div>
