                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="widget-chart-1">
                                    <div class="widget-chart-box-1 float-start" dir="ltr">
                                        <input data-plugin="knob" data-width="70" data-height="70"
                                            data-fgColor="#35b8e0 " data-bgColor="#B8E6F4" value="77" data-skin="tron"
                                            data-angleOffset="180" data-readOnly=true data-thickness=".15" />
                                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="widget-chart-1">
                                    <div class="widget-chart-box-1 float-start" dir="ltr">
                                        <input data-plugin="knob" data-width="70" data-height="70"
                                            data-fgColor="#10c469" data-bgColor="#AAE2C6" value="65" data-skin="tron"
                                            data-angleOffset="180" data-readOnly=true data-thickness=".15" />
                                    </div>
                                    <div class="widget-detail-1 text-end">
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="widget-box-2">
                                    <div class="widget-detail-2 text-end">
                                        <span class="badge bg-primary rounded-pill float-start mt-3">32% <i
                                                class="mdi mdi-trending-up"></i> </span>
                            ...
                            <div class="card-body">
                                ...
                                <div class="widget-box-2 text-end">
                                    <div class="widget-detail-2">
                                        <span class="badge bg-warning rounded-pill float-start mt-3">32% <i
                                                class="mdi mdi-trending-up"></i> </span>
                            ...
                            <div class="text-center card-body">
                                ...
                                <div>
                                    ...
                                    <div class="text-start">
                                        ...
                                        <p class="text-muted font-13"><strong>Mobile :</strong><span class="ms-2">(123)
                                                123 1234</span></p>

                                        <p class="text-muted font-13"><strong>Email :</strong> <span
                                                class="ms-2">coderthemes@gmail.com</span></p>

                                        <p class="text-muted font-13 m-b-5"><strong>Location :</strong> <span
                            ...
                            <div class="card-body">
                                ...
                                <div class="progress progress-bar-alt-success progress-sm mt-0">
                                    <div class="progress-bar bg-success progress-animated wow animated animated"
                                        ...
                                        style="width: 40%; visibility: visible; animation-name: animationProgress;">
                                ...
                                <ul class="list-group mb-0 user-list">
                                    <li class="list-group-item">
                                        <a href="#" class="user-list-item">
                                            ...
                                            <div class="user-desc overflow-hidden">
                                                ...
                                                <span class="desc text-muted font-12 text-truncate d-block">February 24,
                                                    2019 - 10:30am to 12:45pm</span>
                                            </div>
                                        </a>
                                    </li>
                                    ...
                                    <li class="list-group-item">
                                        <a href="#" class="user-list-item">
                                            ...
                                            <div class="user-desc overflow-hidden">
                                                ...
                                                <span class="desc text-muted font-12 text-truncate d-block">February 25,
                                                    2019 - 10:30am to 12:45pm</span>
                                            </div>
                                        </a>
                                    </li>
                                    ...
                                    <li class="list-group-item">
                                        <a href="#" class="user-list-item">
                                            ...
                                            <div class="user-desc overflow-hidden">
                                                <h5 class="name mt-0 mb-1">Meet Manager</h5>
                                                <span class="desc text-muted font-12 text-truncate d-block">February 26,
                                                    2019 - 10:30am to 12:45pm</span>
                                            </div>
                                        </a>
                                    </li>
                                    ...
                                    <li class="list-group-item">
                                        <a href="#" class="user-list-item">
                                            ...
                                            <div class="user-desc overflow-hidden">
                                                <h5 class="name mt-0 mb-1">Project Discussion</h5>
                                                <span class="desc text-muted font-12 text-truncate d-block">February 27,
                                                    2019 - 10:30am to 12:45pm</span>
                                            </div>
                                        </a>
                                    </li>
                                    ...
                                    <li class="list-group-item">
                                        <a href="#" class="user-list-item">
                                            ...
                                            <div class="user-desc overflow-hidden">
                                                <h5 class="name mt-0 mb-1">Meet Manager</h5>
                                                <span class="desc text-muted font-12 text-truncate d-block">February 28,
                                                    2019 - 10:30am to 12:45pm</span>
                                            </div>
                                        </a>
                                    </li>
