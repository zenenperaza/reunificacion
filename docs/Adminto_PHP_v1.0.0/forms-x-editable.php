...
<head>
    ...
    <?php $title = "X Editable";
    include 'partials/title-meta.php'; ?>

    <!-- Plugins css -->
    <link href="assets/libs/x-editable/bootstrap-editable/css/bootstrap-editable.css" rel="stylesheet"
        type="text/css" />
                                    ...
                                    <table class="table table-centered table-borderless table-bordered mb-0">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="#" id="inline-sex" data-type="select" data-pk="1"
                                                        data-value="" data-title="Select sex"></a></td>
                                            </tr>
                                            <tr>
                                                <td>Select, remote array, no buttons</td>
                                                <td><a href="#" id="inline-group" data-type="select" data-pk="1"
                                                        data-value="5" data-source="/groups"
                                                        data-title="Select group">Admin</a></td>
                                            </tr>
                                            <tr>
                                                <td>Select, error while loading</td>
                                                <td><a href="#" id="inline-status" data-type="select" data-pk="1"
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="#" id="inline-dob" data-type="combodate"
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="#" id="inline-comments" data-type="textarea" data-pk="1"
                                                        ...
                                                        data-title="Enter comments">Awesome user!</a></td>
                                            </tr>

                                            <tr>
                                                <td>Checklist</td>
                                                <td><a href="#" id="inline-fruits" data-type="checklist"
                                                        data-value="2,3" data-title="Select fruits"></a></td>
                                            </tr>
