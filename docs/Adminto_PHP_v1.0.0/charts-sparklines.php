...
<div id="wrapper">
    ...
    <?php $pagetitle = "Sparkline Charts";
                    ...
                    <div class="col-xl-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="header-title mt-0 mb-3">Custom Line Chart</h4>
                    ...
                    <div class="col-xl-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="header-title mt-0 mb-3">Mouse Speed Chart Example</h4>
                    ...
                    <div class="col-xl-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="header-title mt-0 mb-3">Composite bar Chart</h4>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-xl-3 text-center">
                                        <div class="mt-3" dir="ltr">
                                            <input data-plugin="knob" data-width="150" data-height="150"
                                                data-cursor=true data-fgColor="#10c469" value="29" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-xl-3 text-center">
                                        <div class="mt-3" dir="ltr">
                                            <input data-plugin="knob" data-width="150" data-height="150"
                                                data-min="-15000" data-displayPrevious=true data-max="15000"
                                                data-step="1000" value="-11000" data-fgColor="#5b69bc" />
                                    ...
                                    <div class="col-md-6 col-xl-3 text-center">
                                        <div class="mt-3" dir="ltr">
                                            <input data-plugin="knob" data-width="150" data-height="150"
                                                data-linecap=round data-fgColor="#435966" value="80" data-skin="tron"
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="header-title mt-0 mb-3">Pie Charts</h4>
                                ...
                                <div class="table-responsive">
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <span data-plugin="peity-pie" data-colors="#71b6f9,#ebeff2"
                                            ...
                                            <tr>
                                                <td>
                                                    <span class="pie" data-plugin="peity-pie"
                                                        data-colors="#71b6f9,#ebeff2" data-width="30"
                                                        data-height="30">0.52/1.561</span>
                                                </td>
                                                <td>
                                                    <code>&lt;span data-plugin="peity-pie" data-colors="#71b6f9,#ebeff2"
                                            ...
                                            <tr>
                                                <td>
                                                    <span class="pie" data-plugin="peity-pie"
                                                        data-colors="#71b6f9,#ebeff2" data-width="30"
                                                        data-height="30">0.52,1.041</span>
                                                </td>
                                                <td>
                                                    <code>&lt;span data-plugin="peity-pie" data-colors="#71b6f9,#ebeff2"
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="header-title mt-0 mb-3">Donut Charts</h4>
                                ...
                                <div class="table-responsive">
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <span class="donut" data-plugin="peity-donut"
                                                        data-colors="#71b6f9,#ebeff2" data-width="30"
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="header-title mt-0 mb-3">Line and Bars Charts</h4>
                                ...
                                <div class="table-responsive">
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <span data-plugin="peity-line" data-fill="#71b6f9"
                                                        data-stroke="#169c81" data-width="120"
                                                        data-height="40">5,3,9,6,5,9,7,3,5,2</span>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <span data-plugin="peity-line" data-fill="#71b6f9"
                                                        data-stroke="#169c81" data-width="120"
                                                        data-height="40">5,3,2,-1,-3,-2,2,3,5,2</span>
                                                </td>
                                                <td>
                                                    <code>&lt;span data-plugin="peity-line" data-fill="#71b6f9"
                                            ...
                                            <tr>
                                                <td>
                                                    <span data-plugin="peity-line" data-fill="#71b6f9"
                                                        data-stroke="#169c81" data-width="120"
                                                        data-height="40">0,-3,-6,-4,-5,-4,-7,-3,-5,-2</span>
                                                </td>
                                                <td>
                                                    <code>&lt;span data-plugin="peity-line" data-fill="#71b6f9"
                                            ...
                                            <tr>
                                                <td>
                                                    <span data-plugin="peity-bar" data-colors="#71b6f9,#ebeff2"
                                                        data-width="100" data-height="30">5,3,9,6,5,9,7,3,5,2</span>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <span data-plugin="peity-bar" data-colors="#71b6f9,#ebeff2"
                                                        data-width="100" data-height="30">5,3,2,-1,-3,-2,2,3,5,2</span>
                                                </td>
                                                <td>
                                                    <code>&lt;span data-plugin="peity-bar" data-colors="#71b6f9,#ebeff2"
                                                                data-width="100"
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="header-title mt-0 mb-3">Data-attributes charts</h4>
...
<script src="assets/js/pages/chart-sparkline.init.js"></script>
