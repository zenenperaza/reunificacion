                                        ...
                                        <div class="timeline-desk">
                                            <div class="panel">
                                                <div class="panel-body">
                                                    ...
                                                    <h4 class="text-danger mt-0">1 hour ago</h4>
                                        ...
                                        <div class="timeline-desk">
                                            <div class="panel">
                                                <div class="panel-body">
                                                    ...
                                                    <h4 class="text-primary mt-0">10 hours ago</h4>
                                                    <p class="timeline-date text-muted"><small>08:25 am</small></p>
                                        ...
                                        <div class="timeline-desk">
                                            <div class="panel">
                                                <div class="panel-body">
                                                    ...
                                                    <h4 class="text-purple mt-0">14 hours ago</h4>
                                                    <p class="timeline-date text-muted"><small>08:25 am</small></p>
                                        ...
                                        <div class="timeline-desk">
                                            <div class="panel">
                                                <div class="panel-body">
                                                    ...
                                                    <h4 class="text-muted mt-0">19 hours ago</h4>
                                                    <p class="timeline-date text-muted"><small>08:25 am</small></p>
                                        ...
                                        <div class="timeline-desk">
                                            <div class="panel">
                                                <div class="panel-body">
                                                    ...
                                                    <h4 class="text-warning mt-0">07 January 2016</h4>
                                                    <p class="timeline-date text-muted"><small>08:25 am</small></p>
                                        ...
                                        <div class="timeline-desk">
                                            <div class="panel">
                                                <div class="panel-body">
                                                    <span class="arrow-alt"></span>
                                                    <span class="timeline-icon bg-primary"><i class="mdi mdi-circle"></i></span>
                                                    <h4 class="text-primary mt-0">07 January 2016</h4>
                                                    <p class="timeline-date text-muted"><small>08:25 am</small></p>
                                        ...
                                        <div class="timeline-desk">
                                            <div class="panel">
                                                <div class="panel-body">
                                                    <span class="arrow"></span>
                                                    <span class="timeline-icon bg-success"><i class="mdi mdi-circle"></i></span>
                                                    <h4 class="text-success mt-0">07 January 2016</h4>
                                                    <p class="timeline-date text-muted"><small>08:25 am</small></p>
                                        ...
                                        <div class="timeline-desk">
                                            <div class="panel">
                                                <div class="panel-body">
                                                    <span class="arrow-alt"></span>
                                                    <span class="timeline-icon"><i class="mdi mdi-circle"></i></span>
                                                    <h4 class="text-muted mt-0">31 December 2015</h4>
                                                    <p class="timeline-date text-muted"><small>08:25 am</small></p>
                                                    <p>Download the new updates of Adminto admin dashboard</p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="timeline-desk">
                                            <div class="panel">
                                                <div class="panel-body">
                                                    <span class="arrow"></span>
                                                    <span class="timeline-icon bg-danger"><i class="mdi mdi-circle">    </i></span>
                                                    <h4 class="text-danger mt-0">16 Decembar 2015</h4>
                                                    <p class="timeline-date text-muted"><small>08:25 am</small></p>
