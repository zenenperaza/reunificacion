                    ...
                    <div class="col-xl-4">
                        <div class="card">
                            <div class="card-body project-box">
                                ...
                                <p class="text-muted font-13">If several languages coalesce the grammar is more simple
                                    and regular than that of the individual languages...<a href="#"
                    ...
                    <div class="col-xl-4">
                        <div class="card">
                            <div class="card-body project-box">
                                ...
                                <p class="text-muted font-13">New common language will be more simple and regular than
                                    the existing European languages...<a href="#" class="text-primary">View more</a>
                                </p>
                    ...
                    <div class="col-xl-4">
                        <div class="card">
                            <div class="card-body project-box">
                                ...
                                <p class="text-muted font-13">It will be as simple as occidental in fact it will be to
                                    an english person it will seem like simplified English...<a href="#"
                                        class="text-primary">view more</a>
                                </p>
                                ...
                                <div class="project-members mb-2">
                                    ...
                                    <div class="avatar-group">
                                        ...
                                        <a href="#" class="avatar-group-item" data-bs-toggle="tooltip"
                                            data-bs-placement="top" title="Joel Heffner">
                                            <img src="assets/images/users/user-2.jpg" class="rounded-circle avatar-sm"
                                                alt="friend" />
                                        </a>
                                    </div>
                        ...
                        <div class="card">
                            <div class="card-body project-box">
                                ...
                                <p class="text-muted font-13">Everyone realizes why a new common language would be
                                    desirable one could refuse to pay expensive translators...<a href="#"
                                        class="text-primary">view more</a>
                                </p>
                    ...
                    <div class="col-xl-4">
                        <div class="card">
                            <div class="card-body project-box">
                                ...
                                <p class="text-muted font-13">At vero eos et accusamus et iusto odio dignissimos ducimus
                                    qui blanditiis praesentium deleniti...<a href="#" class="text-primary">view more</a>
                                </p>
                    ...
                    <div class="col-xl-4">
                        <div class="card">
                            ...
                            <div class="card-body project-box">
                                ...
                                <p class="text-muted font-13">Their separate existence is a myth. For science, music,
                                    sport, etc, Europe uses the same vocabulary....<a href="#" class="text-primary">view
                                        more</a>
                                </p>
