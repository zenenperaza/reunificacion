                                ...
                                <ul class="sortable-list list-unstyled taskList" id="upcoming">
                                    <li>
                                        <div class="kanban-box">
                                            ...
                                            <div class="kanban-detail">
                                                ...
                                                <h5 class="mt-0"><a href="task-details.html" class="text-dark">Improve
                                                        animation loader</a> </h5>
                                    ...
                                    <li>
                                        <div class="kanban-box">
                                            <div class="checkbox-wrapper float-start">
                                                <div class="form-check form-check-success ">
                                                    <input class="form-check-input" type="checkbox" id="singleCheckbox3"
                                                        value="option3" aria-label="Single checkbox Two">
                                                    <label></label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="kanban-detail">
                                                ...
                                                <h5 class="mt-0"><a href="" class="text-dark">Write a release note for
                                                        Admin v1.5</a> </h5>
                                                <ul class="list-inline">
                                                    <li class="list-inline-item">
                                                        <a href="" data-bs-toggle="tooltip" data-bs-placement="top"
                                    ...
                                    <li>
                                        <div class="kanban-box">
                                            <div class="checkbox-wrapper float-start">
                                                <div class="form-check form-check-success ">
                                                    <input class="form-check-input" type="checkbox" id="singleCheckbox4"
                                                        value="option4" aria-label="Single checkbox Two">
                                                    <label></label>
                                                </div>
                                            </div>

                                            <div class="kanban-detail">
                                                <h5 class="mt-0"><a href="task-details.html" class="text-dark">Invite
                                                        user to a project</a> </h5>
                                                <ul class="list-inline">
                                                    <li class="list-inline-item">
                                                        <a href="" data-bs-toggle="tooltip" data-bs-placement="top"
                                                            title="Username">
                                    ...
                                    <li>
                                        <div class="kanban-box">
                                            <div class="checkbox-wrapper float-start">
                                                <div class="form-check form-check-success ">
                                                    <input class="form-check-input" type="checkbox" id="singleCheckbox5"
                                                        value="option2" aria-label="Single checkbox Two">
                                                    <label></label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="kanban-detail">
                                                <span class="badge bg-danger float-end">Urgent</span>
                                                <h5 class="mt-0"><a href="task-details.html" class="text-dark">Code HTML
                                                        email template for welcome email</a> </h5>
                                                <ul class="list-inline">
                                                    <li class="list-inline-item">
                                                        <a href="" data-bs-toggle="tooltip" data-bs-placement="top"
                                                            title="Username">
                                ...
                                <ul class="sortable-list list-unstyled taskList" id="inprogress">
                                    <li>
                                        <div class="kanban-box">
                                            <div class="checkbox-wrapper float-start">
                                                <div class="form-check form-check-success">
                                                    <input class="form-check-input" type="checkbox" id="singleCheckbox6"
                                            ...
                                            <div class="kanban-detail">
                                                <span class="badge bg-danger float-end">Urgent</span>
                                                <h5 class="mt-0"><a href="task-details.html" class="text-dark">File
                                                        Uploads on cards</a> </h5>
                                                <ul class="list-inline">
                                                    <li class="list-inline-item">
                                                        <a href="" data-bs-toggle="tooltip" data-bs-placement="top"
                                                            title="Username">
                                    ...
                                    <li>
                                        <div class="kanban-box">
                                            <div class="checkbox-wrapper float-start">
                                                <div class="form-check form-check-success ">
                                                    <input class="form-check-input" type="checkbox" id="singleCheckbox7"
                                                        value="option7" aria-label="Single checkbox Two">
                                                    <label></label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="kanban-detail">
                                                <span class="badge bg-warning float-end">High</span>
                                                <h5 class="mt-0"><a href="task-details.html" class="text-dark">Enable
                                                        analytics tracking</a> </h4>
                                                    <ul class="list-inline">
                                                        <li class="list-inline-item">
                                                            <a href="" data-bs-toggle="tooltip" data-bs-placement="top"
                                                                title="Username">
                                    ...
                                    <li>
                                        <div class="kanban-box">
                                            <div class="checkbox-wrapper float-start">
                                                <div class="form-check form-check-success ">
                                                    <input class="form-check-input" type="checkbox" id="singleCheckbox8"
                                                        value="option8" aria-label="Single checkbox Two">
                                                    <label></label>
                                                </div>
                                            </div>
                            ...
                            <div class="card-body taskboard-box">
                                    ...
                                    <li>
                                        <div class="kanban-box">
                                            <div class="checkbox-wrapper float-start">
                                                <div class="form-check form-check-success ">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="singleCheckbox11" value="option11"
                                                        aria-label="Single checkbox Two">
                                                    <label></label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="kanban-detail">
                                                <span class="badge bg-warning float-end">High</span>
                                                <h5><a href="task-details.html" class="text-dark">Write a release note
                                                        for Admin v1.5</a> </h5>
                                                <ul class="list-inline">
                                                    <li class="list-inline-item">
                                                        <a href="" data-bs-toggle="tooltip" data-bs-placement="top"
                                        ...
                                        <div class="kanban-box">
                                            <div class="checkbox-wrapper float-start">
                                                <div class="form-check form-check-success  float-start">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="singleCheckbox12" value="option12"
                                                        aria-label="Single checkbox Two">
                                                    <label></label>
                                                </div>
                                            </div>
                                    ...
                                    <li>
                                        <div class="kanban-box">
                                            <div class="checkbox-wrapper float-start">
                                                <div class="form-check form-check-success ">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="singleCheckbox13" value="option13"
                                                        aria-label="Single checkbox Two">
                                                    <label></label>
                                                </div>
                                            </div>
                                ...
                                <div class="text-center pt-2">
                                    <a class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal"
                                        data-bs-target="#custom-modal" data-animation="fadein" data-plugin="custommodal"
