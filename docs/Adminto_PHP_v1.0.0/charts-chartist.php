                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="header-title mt-0 mb-3">Simple line chart</h4>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="header-title mt-0 mb-3">Line Scatter Diagram</h4>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="header-title mt-0 mb-3">Line chart with tooltips</h4>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="header-title mt-0 mb-3">Line chart with area</h4>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="header-title mt-0 mb-3">Bi-polar Line chart with area only</h4>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="header-title mt-0 mb-3">SVG Path animation</h4>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="header-title mt-0 mb-3">Line Interpolation / Smoothing</h4>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="header-title mt-0 mb-3">Different configuration for different series</h4>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="header-title mt-0 mb-3">SVG Animations chart</h4>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="header-title mt-0 mb-3">Bi-polar bar chart</h4>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="header-title mt-0 mb-3">Multi-line labels</h4>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="header-title mt-0 mb-3">Horizontal bar chart</h4>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="header-title mt-0 mb-3">Distributed series</h4>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="header-title mt-0 mb-3">Label placement</h4>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="header-title mt-0 mb-3">Animating a Donut with Svg.animate</h4>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="header-title mt-0 mb-3">Pie chart with custom labels</h4>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="header-title mt-0 mb-3">Gauge chart</h4>
