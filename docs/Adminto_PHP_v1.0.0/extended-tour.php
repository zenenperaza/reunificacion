                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-5">
                                        ...
                                        <p class="text-muted">Suspendisse vel quam malesuada, aliquet sem sit
                                            amet, fringilla elit. Morbi tempor tincidunt tempor. vulputate sapienest
                                            consequat posuere et at velit.</p>

                                        <div class="clearfix"></div>

                                        <h2>This is a Heading 2</h2>
                                        <p class="text-muted">In nec rhoncus eros. Vestibulum eu mattis nisl.
                                            Quisque viverra viverra magna nec pulvinar porta augue, consectetur
                                            facilisis diam a malesuada purus.</p>
                                        ...
                                        <p class="text-muted">Nulla et mattis nunc. Curabitur scelerisque
                                            commodo condimentum. Mauris blandit, velit a consectetur egestas ultrices
                                            arcu eros vel erat.</p>

                                    </div>

                                    <div class="col-lg-5 offset-lg-1">
                                        <h4 class="header-title mt-0 mb-4">Blockqoutes</h4>

                                        <blockquote class="blockquote font-16" id="blockquote-title-tour">
                                        ...
                                        <blockquote class="blockquote font-16 blockquote-reverse">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere
                                                erat a ante.</p>
                                            <footer class="blockquote-footer">Someone famous in <cite
                                                    title="Source Title">Source Title</cite></footer>
