...
<div class="container-fluid">
    ...
    <x-breadcrumb title="Editar Indicador" icono="<i class='mdi mdi-chart-line'></i>" />
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('indicadores.update', $indicador) }}">
                @csrf
                @method('PUT')
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="codigo" class="form-control @error('codigo') is-invalid @enderror"
                               value="{{ old('codigo', $indicador->codigo) }}" required>
                    ...
                    <div class="col-md-8">
                        ...
                        <input type="text" name="descripcion" class="form-control @error('descripcion') is-invalid @enderror"
                               value="{{ old('descripcion', $indicador->descripcion) }}" required>
