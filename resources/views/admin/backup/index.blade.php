                    ...
                    <table class="table table-bordered table-hover mb-0">
                        ...
                        <tbody>
                            @forelse($files as $file)
                                <tr>
                                    <td>{{ $file['name'] }}</td>
                                    <td>{{ \Carbon\Carbon::createFromTimestamp($file['modified'])->timezone('America/Caracas')->format('d/m/Y H:i') }}
                                    </td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <form method="POST" action="{{ route('backup.delete', $file['name']) }}"
                                            ...
                                            <button type="button" class="btn btn-danger btn-sm btn-delete"
                                                data-file="{{ route('backup.delete', $file['name']) }}">
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="text-center text-muted">No hay archivos de respaldo
                                        disponibles.</td>
                                </tr>
                            @endforelse
                        </tbody>
